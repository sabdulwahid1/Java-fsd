...
<h2>Admin Home</h2> 
<a class="link" href="adminhome.jsp">Home</a> <br> 

<a class="link" href="addrail.jsp">Add Railway Crossing</a> <br> 

<a class="link" href="search.jsp">Search Crossing</a> <br> <br>
	...
	<c:forEach var="row" items="${result.rows}">
	 ...
	 <tr> 
		...
		<td>
				...
				<form action="upadate.jsp" method="GET"> 
